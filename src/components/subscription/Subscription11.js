...
function Subscription11({ info, date }) {
    ...
    <>
      ...
      <div className="subscription_detail_section">
        ...
        <div className="table_scroll">
          <table className="subscription_detail_price_table">
            ...
            <tbody>
              {info.detailList.map((d) => (
                <tr key={d.modelNo}>
                  <td>{d.houseTy}</td>
                  <td>{d.suplyHshldco}</td>
                  <td>{d.lttotTopAmount}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="subscription_detail_section">
        ...
        <div className="subscription_detail_explan">
          ...
          {info.press ? (
            <span>
              *기타 자세한 모집공고문 내용은 {info.rcritPblancDe} {info.press}에
              게시된 내용을 참고하시기 바랍니다.
            </span>
          ) : (
            <span>
